...
/* USER_CTRL bit masks. */
#define ICM20948_USER_CTRL_FIFO_EN_MASK 0x40u
#define ICM20948_USER_CTRL_I2C_MST_EN_MASK 0x20u

/* INT / FIFO control bit masks. */
#define ICM20948_INT_ENABLE_1_RAW_DATA_RDY_MASK 0x01u
#define ICM20948_INT_ENABLE_2_FIFO_OVERFLOW_MASK 0x1Fu
#define ICM20948_INT_ENABLE_3_FIFO_WM_MASK 0x1Fu
#define ICM20948_FIFO_EN_2_TEMP_MASK 0x01u
#define ICM20948_FIFO_EN_2_GYRO_X_MASK 0x02u
#define ICM20948_FIFO_EN_2_GYRO_Y_MASK 0x04u
#define ICM20948_FIFO_EN_2_GYRO_Z_MASK 0x08u
#define ICM20948_FIFO_EN_2_ACCEL_MASK 0x10u
#define ICM20948_FIFO_EN_2_ACCEL_GYRO_MASK \
    (ICM20948_FIFO_EN_2_ACCEL_MASK |      \
     ICM20948_FIFO_EN_2_GYRO_X_MASK |     \
     ICM20948_FIFO_EN_2_GYRO_Y_MASK |     \
     ICM20948_FIFO_EN_2_GYRO_Z_MASK)
#define ICM20948_FIFO_RESET_MASK 0x1Fu
#define ICM20948_FIFO_MODE_STREAM 0x00u
#define ICM20948_FIFO_CFG_STATUS_EN 0x01u
...
typedef struct
{
    ...
    icm20948_vec3_t accel_bias;
    icm20948_vec3_t gyro_bias;
    bool bias_valid;
} icm20948_t;
...
typedef enum
{
    ICM20948_PROFILE_DEFAULT = 0,
    ICM20948_PROFILE_SWALLOW_IMU1,
    ICM20948_PROFILE_CONTEXT_IMU2
} icm20948_profile_t;
...
* ============================================================================
*/
extern icm20948_t m_icm20948[NUM_ICM_DEVICES];
extern nrf_drv_twi_t m_twi_icm20948;
